...
export const countries = [
    ...
    { name: "Congo", code: "242" },
    { name: "Congo, the Democratic Republic of the", code: "242" },
    ...
    { name: "Russian Federation", code: "70" },
...
export const specializations = [
    "Aeronautical engineering", "Agricultural science", "Allied health professions", "Anatomy and taxonomy", "Anthropology", "Applied physics", "Archaeology", "Artificial intelligence and robotics", "Astronomy and astrophysics", "Atomic, molecular, and optical physics", "Behavioral science", "Biochemistry", "Biochemistry and molecular biology", "Biomedical engineering", "Biotechnology", "Botany", "Business, management, and accounting", "Cardiology", "Chemical Engineering", "Chemistry", "Civil engineering", "Communication studies", "Computer science and information systems", "Condensed matter physics", "Cultural studies", "Decision sciences", "Dentistry", "Dermatology", "Earth and planetary sciences", "Ecology", "Economics, econometrics, and finance", "Education", "Electronics and electrical engineering", "Energy", "ENT (Otolaryngology)", "Entomology", "Environmental science", "Ethnic and gender studies", "Evolutionary biology", "Experimental physics", "Fine arts", "Gastroenterology and hepatology", "Genetics and genomics", "Geography", "Geriatrics", "Hematology", "History", "Humanities, Arts, and Social Sciences", "Immunology and microbiology", "Industrial engineering", "Infectious diseases", "Information science", "Inorganic chemistry", "Internal medicine", "Law", "Linguistics", "Literature", "Materials science", "Mathematics", "Mechanical engineering", "Media and journalism", "Medicine and Life Sciences", "Music", "Nanotechnology", "Neuroscience and neurology", "Nuclear and particle physics", "Nursing", "Nursing/Healthcare", "Nutrition and dietetics", "Obstetrics and gynecology", "Oncology", "Ophthalmology", "Organic chemistry", "Orthopedics", "Other – humanities, arts, and social sciences", "Other – medicine and life sciences", "Other – physical sciences and engineering", "Pathology", "Pediatrics", "Performing arts", "Personal communication", "Pharmacology, toxicology, and pharmaceutics", "Philosophy", "Physical chemistry", "Physical Sciences and Engineering", "Physics", "Physiology", "Plastic surgery", "Political science", "Preventive medicine and public health", "Psychiatry and clinical psychology", "Psychology", "Quantum physics", "Religious studies and theology", "Respiratory care", "Robotics", "Sociology", "Sports and recreation studies", "Sports medicine", "Statistics", "Surgery", "Theoretical chemistry", "Theoretical physics", "Urology", "Veterinary", "Visual arts", "Zoology"
];
