            ...
            if (type !== 'all' || forceShowEmpty) {
                return (
                    <div className="text-center py-20 px-6 bg-gradient-to-br from-white via-gray-50 to-white rounded-2xl shadow-xl border-2 border-gray-200 hover:shadow-2xl transition-all duration-300">
                        ...
                        <h2 className="text-2xl font-bold text-[#204066] mb-3">No {title} Available</h2>
            ...
            <div className="container mx-auto px-4">
                ...
                {type === 'all' ? (
                    <>
                        ...
                        {(upcomingTemplates.length === 0 && previousTemplates.length === 0) ? (
                            renderConferenceList([], 'all', "Conferences", true)
                        ) : (
                            <>
                                {renderConferenceList(upcomingTemplates, 'upcoming', "Upcoming Conferences")}
                                {upcomingTemplates.length > 0 && previousTemplates.length > 0 && <div className="mt-8"></div>}
